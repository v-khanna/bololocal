...
struct OnboardingView: View {
    ...
    private var accessibility: some View {
        VStack(spacing: 16) {
            ...
            Text("HearIt needs Accessibility access to read text you select in other apps. Nothing leaves your Mac.")
                .multilineTextAlignment(.center)
                .foregroundStyle(.secondary)
                .padding(.horizontal, 24)
    ...
    private var modelDownload: some View {
        VStack(spacing: 16) {
            ...
            Text(downloadProgress.isComplete ? "Voice ready" : "Downloading voice model")
                .font(.title2)
            Text("HearIt is downloading the Qwen3-TTS model — about 500 MB. This happens once.")
                .multilineTextAlignment(.center)
                .foregroundStyle(.secondary)
                .padding(.horizontal, 24)
